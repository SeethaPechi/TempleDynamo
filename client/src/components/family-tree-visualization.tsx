  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-center">
        <Card className="p-6 bg-gradient-to-r from-saffron-500 to-gold-500 text-white max-w-md">
          <div className="text-center">
            <div className="w-16 h-16 bg-white rounded-full flex items-center justify-center mx-auto mb-4">
              <Users className="text-saffron-500" size={32} />
            </div>
            <h2 className="text-xl font-bold mb-2">{member.fullName}</h2>
            <p className="text-saffron-100 text-sm mb-2">Member #{member.id}</p>
            <div className="flex items-center justify-center text-saffron-100 text-xs">
