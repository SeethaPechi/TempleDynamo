        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="text-center">
            ...
            <p className="text-lg max-w-2xl mx-auto mb-12 opacity-80">
              Connect with your temple community, track family relationships,
              manage member information, and stay connected through WhatsApp
              messaging.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/register">
                <Button
                  size="lg"
                  className="bg-black text-black-600 hover:bg-gray-50 text-lg px-8 py-3"
                >
              ...
              <Link href="/signin">
                <Button
                  size="lg"
                  variant="outline"
                  className="border-white text-black hover:bg-white hover:text-saffron-600 text-lg px-8 py-3"
                >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Comprehensive tools to strengthen temple community bonds and
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card className="p-6 text-center hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-600">
                Register and manage family member information with detailed
            ...
            <Card className="p-6 text-center hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-600">
                Visualize family relationships and genealogical connections
            ...
            <Card className="p-6 text-center hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-600">
                Manage temple information, events, and connect members with
                their primary temples
              </p>
            </Card>
            ...
            <Card className="p-6 text-center hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-600">
                Send community announcements and stay connected through WhatsApp
                messaging
              </p>
            </Card>
            ...
            <Card className="p-6 text-center hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-600">
                Track festivals, celebrations, and community gatherings with
                event management
              </p>
            </Card>
            ...
            <Card className="p-6 text-center hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-600">
                Coordinate volunteer activities and community service
                initiatives
              </p>
            </Card>
          </div>
      ...
      <div className="bg-temple-brown text-white py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <Link href="/register">
            <Button
              size="lg"
              className="bg-saffron-500 hover:bg-saffron-600 text-white text-lg px-8 py-3"
            >
              <UserPlus className="mr-2" size={20} />
              Get Started Now
            </Button>
