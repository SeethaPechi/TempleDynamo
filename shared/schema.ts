...
export const members = pgTable("members", {
  ...
  spouseName2: text("spouse_name_2"),
  fullNameTa: text("full_name_ta"),
  fatherNameTa: text("father_name_ta"),
  motherNameTa: text("mother_name_ta"),
  spouseNameTa: text("spouse_name_ta"),
  spouseName2Ta: text("spouse_name_2_ta"),
  birthCityTa: text("birth_city_ta"),
  currentCityTa: text("current_city_ta"),
